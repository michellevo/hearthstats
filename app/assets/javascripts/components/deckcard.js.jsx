var DeckCard = React.createClass({
	...
	render: function() {
		var cardName = this.props.card.name.trim().
		...
		var cardClass = "card cardWrapper "
		...
		if (this.state.hover) {
			var fullDeckImage = <img
				id="deckBuilderFullCardView"
				key={this.props.card.id}
				ref="fullDeckImage"
				src={"//s3.amazonaws.com/hearthstatsprod/full_card/" + cardName + ".png"}
				style={this.state.deckImageStyle} />;
		}

		return (
			<div onMouseOver={this.mouseOver} onMouseOut={this.mouseOut()}>
				<div onClick={this.handleClick} key={cardName} alt={cardName} className={cardClass}>
					<div className="mana">
					...
					<img src={"//s3.amazonaws.com/hearthstatsprod/deck_images/" + cardName +".png"} className="image"/>
					<div className="bg">
					</div>
				</div>
				{fullDeckImage}
